...
.factory('MeasurementClientService', function($q, MeasurementService,
    ...
    MeasurementClientService.start = function (server, port, path, interval, backgroundInitiated) {
        var setMetroSelection = SettingsService.currentSettings.metroSelection;
		var clientDefer = $q.defer();
		var emitKey = (typeof backgroundInitiated !== 'undefined' || backgroundInitiated === false) ? 'measurement:foreground' : 'measurement:background';
